...
<!--     <li><a data-toggle="tab" href="#menu3">Menu 3</a></li> -->
  ...
  <div class="tab-content">
      ...
      <div class="panel panel-default ">
				...
				<div class="panel-body">
					<div class="col-md-12 animated bounceInLeft">
										<h3>Added Job categories</h3>
					<div class="col-md-12">
					
						<table class="table sortable " id="added_job-category">
							<thead>
								<tr>
	...
	String query = " SELECT * FROM `job_category` WHERE delete_status = 0 ORDER BY date DESC ";
			...
			try {
				...
				while(rs.next()) { 
					String data = "<tr>"+
							...
							"<td><button class='btn btn-info btn-sm for-edit-job-category' data-id='" + rs.getString("name") + "'>edit</button> </td>"+
						"</tr>";
					out.print(data);
				}
...
<!-- 			</div> -->
				<div class="panel-body">
					...
					<form class="form-horizontal " id="add-job-category">
    ...
    <div id="menu2" class="tab-pane fade"> 
      <div class="panel panel-default "> 
				...
				<h4> Edit Job category </h4>
					...
					<form class="form-horizontal " id="edit-job-category">
					...
					<div class="form-group    has-feedback  ">
					    ...
					    <div class="col-md-offset-8 col-md-2">
					      <button class="btn btn-danger" id="delete_this_job-category" >Delete</button>
					    </div>
					    <div class="col-md-2">
