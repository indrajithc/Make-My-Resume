		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="col-md-offset-2 col-md-6">
					...
					<form class="form-horizontal" id="validate_me">
					...
					<div class="form-group    has-feedback  ">
						...
						<div class="form-group    has-feedback  ">
							<label class="control-label col-sm-2 text-capitalize" for="url">Url:</label>
							<div class="col-sm-10">
						...
						<div class="form-group    has-feedback  ">
							<label class="control-label col-sm-2 text-capitalize" for="url">join_date:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="join_date" placeholder="Enter join_date" name="join_date"   data-date-format="dd-mm-yyyy">  
							</div>
						</div>
						
					
						<div class="form-group    has-feedback  ">
							<label class="control-label col-sm-2 text-capitalize" for="url">comment:</label>
							<div class="col-sm-10"> 
						...
						<div class="form-group    has-feedback  "> 
							<div class="col-sm-offset-2 col-sm-10">
							 Check me out <input type="checkbox"   id="check"   name="check" > 
							</div>
						</div>
						...
						<div class="form-group     has-feedback ">
							<label class="control-label col-sm-2 text-capitalize" for="password">Password:</label>
							<div class="col-sm-10">
						...
						<div class="form-group     has-feedback ">
							<label class="control-label col-sm-2 text-capitalize" for="password">Confirm Password:</label>
							<div class="col-sm-10">
