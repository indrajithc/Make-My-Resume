...
<!--     <li><a data-toggle="tab" href="#menu3">Menu 3</a></li> -->
  ...
  <div class="tab-content">
      ...
      <div class="panel panel-default ">
				...
				<div class="panel-body">
					<div class="col-md-12 animated bounceInLeft">
										<h3>Added language categories</h3>
					<div class="col-md-12">
					
						<table class="table sortable " id="added_language">
							<thead>
								<tr>
	...
	String query = "SELECT l.*, c.name AS cdddname FROM `language` l LEFT JOIN language_category c ON l.category = c.id WHERE l.delete_status = 0 AND c.delete_status = 0 ORDER BY l.date DESC ";
			...
			try {
				...
				while(rs.next()) { 
					String data = "<tr>"+
							...
							"<td value='" + rs.getString("category") + "' >" + rs.getString("cdddname") + " </td>"+
							"<td>" + rs.getString("description") + " </td>"+
							"<td><button class='btn btn-info btn-sm for-edit-language' data-id='" + rs.getString("name") + "'>edit</button> </td>"+
						"</tr>";
					out.print(data);
				}
...
<!-- 			</div> -->
				<div class="panel-body">
					...
					<form class="form-horizontal " id="add-language">
	...
	String querya = " SELECT * FROM `language_category` WHERE delete_status = 0 ORDER BY date DESC ";
 ...
 <div id="menu2" class="tab-pane fade"> 
      <div class="panel panel-default "> 
				...
				<h4> Edit language </h4>
					...
					<form class="form-horizontal " id="edit-language">
 ...
 cona = new includes.Connection();
	 ...
	 querya = " SELECT * FROM `language_category` WHERE delete_status = 0 ORDER BY date DESC ";
	...
	%>						
					    ...
					    <div class="col-md-offset-8 col-md-2">
					      <button class="btn btn-danger" id="delete_this_language" >Delete</button>
					    </div>
					    <div class="col-md-2">
