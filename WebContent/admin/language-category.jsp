...
<!--     <li><a data-toggle="tab" href="#menu3">Menu 3</a></li> -->
  ...
  <div class="tab-content">
	...
	String query = " SELECT * FROM `language_category` WHERE delete_status = 0 ORDER BY date DESC ";
			...
			try {
				...
				while(rs.next()) { 
					String data = "<tr>"+
							...
							"<td><button class='btn btn-info btn-sm for-edit-language-category' data-id='" + rs.getString("name") + "'>edit</button> </td>"+
						"</tr>";
					out.print(data);
				}
...
<!-- 			</div> -->
				<div class="panel-body">
					...
					<form class="form-horizontal " id="add-language-category">
 ...
 <div id="menu2" class="tab-pane fade"> 
      <div class="panel panel-default "> 
				<div class="panel-body">
				<h4> Edit language category </h4>
				
					<div class="col-md-12 animated bounceInLeft">
					
					<form class="form-horizontal " id="edit-language-category">
					...
					<div class="form-group    has-feedback  ">
					    ...
					    <div class="col-md-offset-8 col-md-2">
					      <button class="btn btn-danger" id="delete_this_language-category" >Delete</button>
					    </div>
					    <div class="col-md-2">
