...
<!--     <li><a data-toggle="tab" href="#menu3">Menu 3</a></li> -->
  ...
  <div class="tab-content">
	...
	includes.Connection  con = new includes.Connection();
	 ...
	 String query = " SELECT * FROM `education` WHERE delete_status = 0 ORDER BY date DESC ";
			...
			try {
				...
				while(rs.next()) { 
					String data = "<tr>"+
							...
							"<td><button class='btn btn-info btn-sm for-edit-education' data-id='" + rs.getString("name") + "'>edit</button> </td>"+
						"</tr>";
					out.print(data);
				}
