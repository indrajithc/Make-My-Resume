...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-3 col-md-6">
					<div id="logbox">
						<form id="login-form" method="post" class="form-horizontal hidden"
							<%= destination %>>
							<h1>Login</h1>
						...
						<a href="employer"  class="btn btn- inputButton" >employer</a>
						<a href="employee"  class="btn btn- inputButton" >employee</a>
						<a href="admin"  class="btn btn- inputButton" >admin</a>
						</form>
					</div>
				</div>
				<!--col-md-6-->
	...
	<script type="text/javascript" src="<%out.print(controller.Controller.returnPath (request));%>/assets/js/jquery000.js" ></script>
