...
<!--     <li><a data-toggle="tab" href="#menu3">Menu 3</a></li> -->
  ...
  <div class="tab-content">
	...
	<%
	  ...
	  query = " SELECT * FROM `competencies` WHERE delete_status = 0  ORDER BY date DESC ";
			...
			try {
				...
				while(rs.next()) { 
					...
					if(rs.getInt("employer") == Integer.parseInt(id) ){
						data = data +
"<td><button class='btn btn-info btn-xs for-edit-competencies' data-id='" + rs.getString("name") + "'>edit</button> </td>";	
					} else {
						data = data +
...
<!-- 			</div> -->
				<div class="panel-body">
					...
					<form class="form-horizontal " id="add-competencies">
