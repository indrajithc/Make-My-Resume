...
<!--     <li><a data-toggle="tab" href="#menu3">Menu 3</a></li> -->
  ...
  <div class="tab-content">
      ...
      <div class="panel panel-default ">
				...
				<div class="panel-body">
					...
					<div class="col-md-12">
						...
						<table class="table sortable " id="added_skills">
							<thead>
								<tr>
	...
	<%
	  ...
	  query = " SELECT * FROM `skills` WHERE delete_status = 0   ORDER BY date DESC ";
			...
			try {
				...
				while(rs.next()) { 
					...
					if(rs.getInt("employer") == Integer.parseInt(id) ){
						data = data +
"<td><button class='btn btn-info btn-xs for-edit-skills' data-id='" + rs.getString("name") + "'>edit</button> </td>";	
					} else {
						data = data +
...
<!-- 			</div> -->
				<div class="panel-body">
					...
					<form class="form-horizontal " id="add-skills">
 ...
 <div id="menu2" class="tab-pane fade"> 
      <div class="panel panel-default "> 
				...
				<h4> Edit skills </h4>
					...
					<form class="form-horizontal " id="edit-skills">
					...
					<div class="form-group    has-feedback  ">
					    ...
					    <div class="col-md-offset-8 col-md-2">
					      <button class="btn btn-danger" id="delete_this_skills" >Delete</button>
					    </div>
					    <div class="col-md-2">
