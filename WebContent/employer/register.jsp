...
<body id="login">
  ...
  <h2 class="form-heading">Company Register</h2>
  <form class="form-signin app-cam"  id="register-form">
      <p>Enter your details below</p>
      <input name="company" id="company" type="text" class="form-control1" placeholder="Company Name" autofocus="">
      <input name="pin" id="pin"  type="text" class="form-control1" placeholder="pin" autofocus="">
              
       <select class="form-control1"  id="country" name="country"></select>
      
       <select  class="form-control1"  name="state" id="state"></select>
    					
      <input name="username" id="username" type="text" class="form-control1" placeholder="Email" autofocus="">
      ...
      <input name="mobile" id="mobile" type="number" class="form-control1" placeholder="User mobile number" autofocus="">
      <input name="password" id="password" type="password" class="form-control1" placeholder="Password">
      <input name="cpassword" id="cpassword"  type="password" class="form-control1" placeholder="Re-type Password">
      <label class="checkbox-custom check-success">
          <input name="checkbox1" type="checkbox" value="agree this condition" id="checkbox1"> <label for="checkbox1">I agree to the Terms of Service and Privacy Policy</label>
      </label>
      <button class="btn btn-lg btn-success1 btn-block" type="submit">Submit</button>
      <div class="registration">
          Already Registered.
          <a class="" href="employerloginpage">
              Login
          </a>
      </div>
  </form>
	...
	$(document).ready ( function () {
		...
		$("#register-form").validate({
			...
			submitHandler: function(form, event){
				...
				var toServerValues = {};
				toServerValues["action"] = "employer-register";

				$("#register-form").find('input, textarea , select').each(function() {
				...
				$.post('controller',toServerValues,function(response){
				 ...
				 console.log(response); 
					if (response.success == -1) {
						...
						window.location.replace(response.url + "?confirm=0");
						
					} else if (response.success == 2) {
						
						$('#username').after('<label id="username-error" class="error" for="username">email already exists</label>');
						
					}  else if (response.success == 3) {
						

						$('#mobile').after('<label id="username-error" class="error" for="username">mobile already exists</label>');
					...
					$("#register-form").find('input[type="submit"]').css('cursor', 'default');
