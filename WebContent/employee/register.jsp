					...
					<div class="sign-up">
						...
						<div class="sign-u">
							...
							<div class="sign-up2">
									...
									<input name="cpassword" id="cpassword" type="password" placeholder=" " required=" "/>
						...
						<div class="sub_home">
							...
							<div class="sub_home_right">
								<p>Go Back to <a href="employeeloginpage">login</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
	...
	$(document).ready ( function () {
		...
		$("#register-form").validate({
			...
			submitHandler: function(form, event){
				...
				var toServerValues = {};
				toServerValues["action"] = "employee-register";
				...
				$.post('controller',toServerValues,function(response){
				 ...
				 console.log(response); 
					if (response.success == -1) {
						...
						$('#mobile').after('<label id="mobile-error" class="error" for="mobile">mobile already exists</label>');
