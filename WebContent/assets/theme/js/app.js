...
$.AdminLTE = {}, $.AdminLTE.options = {
    ...
    $("ul.sidebar-menu>li>a").hover(function () {
       $(this).find("i").toggleClass("faa-wrench animated");
    });
    
    
    
    
    $(".subicon-animated").hover(function () {
       $(this).find("i").toggleClass("faa-wrench animated");
    });
  ...
  /*====================================================================================================================*/  
   ...
   $(document).ready( function() {	   
	   $('ul.sidebar-menu.my-menu').find('li.active').each( function () {
	    	$(this).removeClass('active');
	    });

	   current_loc_name = getUrlParameter("page", decodeURIComponent(window.location.search.substring(1)));
	   $('ul.sidebar-menu.my-menu').find('li>a').each( function () {
	    	$href = $(this).attr('href');
	    	if($href != null && $href != "#"){
	    		nere_loc_name = getUrlParameter("page", $href.split('?')[1]);	    		
	    		console.log(current_loc_name , nere_loc_name );
	    		if(current_loc_name == nere_loc_name ){
	    			$(this).parent('li').addClass('active');
	    			$('ol.breadcrumb>li.now_home').html('<a href="'+$href+'"><i class="fa fa-dashboard"></i> Base</a>');
	    		}
	    	}
	    });
	     ...
	     function getUrlParameter( sParam, sPageURL) {   	 
	        var sURLVariables = sPageURL.split('&'),
	            sParameterName, return_me = null , i;
	        for (i = 0; i < sURLVariables.length; i++) {
	            sParameterName = sURLVariables[i].split('=');
	            if (sParameterName[0] === sParam) {
	            	return_me = sParameterName[1] === undefined ? true : sParameterName[1];
	            }
	        }
	        return return_me;
	    }  
