...
/*==================================================================================================================*/	
	...
	$("#update-employer").validate({
		...
		submitHandler: function(form, event){
			var toServerValues = {};
			toServerValues['action'] = 'update-employer';

			$("#update-employer").find('input, textarea, select ').each(function() {
...
/*=================================================================================================================*/	
	...
	$("#add-skills").validate({
		...
		submitHandler: function(form, event){ 
			...
			var toServerValues = {};
			toServerValues['action'] = 'add-skills';

			$("#add-skills").find('input, textarea ').each(function() {
				if($(this).attr('type') != "submit") {
			...
			$.post('controller',toServerValues,function(response){
				...
				if (response.success == -1) {
					...
					// success code
					$("#add-skills").find("input[type=text], input[type=password], input[type=email] , textarea").val("");
					data = "<tr class='animated bounceInDown' >"+
						"<td>" +  toServerValues.name  + " </td>"+
						"<td>" +  toServerValues.description  + " </td>"+
						"<td><button class='btn btn-info btn-xs for-edit-skills' data-id='" +  name + "'>edit</button> </td>"+
					"</tr>";
					$('#added_skills>tbody').prepend(data);
	...
	$("#edit-skills").validate({
		...
		submitHandler: function(form, event){
			...
			$.post('controller',{action:'edit-skills',name:name, description: description},function(response){
				console.log(response); 
				if (response.success == -1) {
					if (!response.authentication) 
						window.location.replace(response.page+"?referrer="+response.to);
	...
	$('#delete_this_skills').click(function () {
		...
		$.post('controller',{action:'delete-skills',name:name},function(response){
			console.log(response); 
			if (response.success == -1) {
				if (!response.authentication) 
					window.location.replace(response.page+"?referrer="+response.to);
	...
	$("#add-competencies").validate({
		...
		submitHandler: function(form, event){ 
			...
			var toServerValues = {};
			toServerValues['action'] = 'add-competencies';

			$("#add-competencies").find('input, textarea ').each(function() {
				if($(this).attr('type') != "submit") {
					toServerValues[$(this).attr('id')+''] = $(this).val()+'';
				}
			}); 
			...
			$.post('controller',toServerValues,function(response){
				...
				if (response.success == -1) {
					...
					// success code
					$("#add-competencies").find("input[type=text], input[type=password], input[type=email] , textarea").val("");
					data = "<tr class='animated bounceInDown' >"+
						"<td>" +  toServerValues.name  + " </td>"+
						"<td>" +  toServerValues.description  + " </td>"+
						"<td><button class='btn btn-info btn-xs for-edit-competencies' data-id='" +  name + "'>edit</button> </td>"+
					"</tr>";
					$('#added_competencies>tbody').prepend(data);
	...
	$("#edit-competencies").validate({
		...
		submitHandler: function(form, event){
			...
			$.post('controller',{action:'edit-competencies',name:name, description: description},function(response){
				console.log(response); 
				if (response.success == -1) {
					if (!response.authentication) 
						window.location.replace(response.page+"?referrer="+response.to);
	...
	$('#delete_this_competencies').click(function () {
		...
		$.post('controller',{action:'delete-competencies',name:name},function(response){
			console.log(response); 
			if (response.success == -1) {
				if (!response.authentication) 
					window.location.replace(response.page+"?referrer="+response.to);
	...
	$("#add-education").validate({
		...
		submitHandler: function(form, event){ 
			...
			var toServerValues = {};
			toServerValues['action'] = 'add-education';

			$("#add-education").find('input, textarea ').each(function() {
				if($(this).attr('type') != "submit") {
					toServerValues[$(this).attr('id')+''] = $(this).val()+'';
				}
			}); 
			...
			$.post('controller',toServerValues,function(response){
				...
				if (response.success == -1) {
					...
					// success code
					$("#add-education").find("input[type=text], input[type=password], input[type=email] , textarea").val("");
					data = "<tr class='animated bounceInDown' >"+
						"<td>" +  toServerValues.name  + " </td>"+
						"<td>" +  toServerValues.description  + " </td>"+
						"<td><button class='btn btn-info btn-xs for-edit-education' data-id='" +  name + "'>edit</button> </td>"+
					"</tr>";
					$('#added_education>tbody').prepend(data);
	...
	$(document).on( "click", '.for-edit-education', function() {   
		console.log('fffff');
        try {
        	base = $(this).closest('tr');
	   		 name = base.find("td:nth-child(1)").text();
	   		 description = base.find("td:nth-child(2)").text();
	   		 $('#edit-education').find('#edit-name').val(name);
	   		 $('#edit-education').find('#edit-description').val(description); 
   	        activaTab('menu2');
        }
        catch(err) {
   	        activaTab('home'); 
	...
	$("#edit-education").validate({
		...
		submitHandler: function(form, event){
			...
			$.post('controller',{action:'edit-education',name:name, description: description},function(response){
				console.log(response); 
				if (response.success == -1) {
					if (!response.authentication) 
						window.location.replace(response.page+"?referrer="+response.to);
					...
					$('#added_education>tbody').find('tr').each( function() {
						$this = $(this);
						if($this.find("td:nth-child(1)").text() == name){
							$this.addClass('animated flipInX');
							$this.find("td:nth-child(2)").text(description);
	...
	$('#delete_this_education').click(function () {
		...
		$.post('controller',{action:'delete-education',name:name},function(response){
			console.log(response); 
			if (response.success == -1) {
				if (!response.authentication) 
					window.location.replace(response.page+"?referrer="+response.to);
	...
	$("#add-vacancies").validate({
		...
		submitHandler: function(form, event){
			var toServerValues = {};
			toServerValues['action'] = 'add-vacancies';

			$("#add-vacancies").find('input, textarea, select ').each(function() {
			...
			$.post('controller',toServerValues,function(response){
				...
				if (response.success == -1) {
					...
					"<td>" + toServerValues.place + " </td>"+
					"<td>" + toServerValues.salary + " </td>"+
					"<td>" + toServerValues.interview  + " </td>"+
					"<td>" + "now" + " </td>"+
					"<td><button class='btn btn-info btn-xs for-edit-vacancies' data-id='" + response.id + "'>edit</button> </td>"+
				"</tr>";
					
					$('#added_vacancies>tbody').prepend(data);
			 		...
			 		$("#add-vacancies").find("input, textarea").val("");
	...
	$('.job_category').change(function() {
		...
		$.post('controller',{action:'get-job',category:$(this).val()},function(response){
			console.log(response); 
			if (response.success == -1) {
				if (!response.authentication) 
					window.location.replace(response.page+"?referrer="+response.to);
	   	        ...
	   	        $.each(data, function(i, item){ 
	   	         $('.job').append($('<option title="'+ item.purpose+'" value="'+ item.id+'">'+
	   	        		 item.title +'</option>' ));
	...
	$(document).on('click', '.for-edit-vacancies', function() {
		...
		$.post('controller',{action:'get-vacancies',id:id},function(response){
			console.log(response); 
			if (response.success == -1) {
				if (!response.authentication) 
					window.location.replace(response.page+"?referrer="+response.to);
	   	        ...
	   	        try {
		   	         ...
		   	         $.each(response,function (key, data) { 
				   	      $('#edit-vacancies').find('#edit-'+key).val(data);
				   	}); 
		   	         
		   	         
		   	         $('#edit-job_category').val(response.job_category).trigger('change');
		   	         setTimeout(function(){
			   	         $('#edit-job').val(response.job);		   	        	 
		   	         },1000);
		   	         
		   	         
		   	         $('#editActionDelteHereme').html($('<button type="button" class="col-xs-12 btn btn-danger btn-xs" id="delete-vecacies" data-id="'+id+'">delete</button>'));
	...
	$("#edit-vacancies").validate({
		...
		submitHandler: function(form, event){
			var toServerValues = {};
			toServerValues['action'] = 'edit-vacancies';

			$("#edit-vacancies").find('input, textarea, select ').each(function() {
				if($(this).attr('type') != "submit") {
					var toData = $(this).val();
					if(toData.length <1)
						toData = 'NULL';
			...
			jjob = $('#edit-job').find('option:selected').text();
			...
			$.post('controller',toServerValues,function(response){
				...
				if (response.success == -1) {
					...
					"<td>" + toServerValues.interview  + " </td>"+
					"<td>" + "now" + " </td>"+
					"<td><button class='btn btn-info btn-xs for-edit-vacancies' data-id='" + toServerValues.id + "'>more</button> </td>"+
				" ";
					
					$('#added_vacancies>tbody>tr').each(function() {
						if($(this).find('button').attr('data-id') == toServerValues.id){
							$(this).empty();
							$(this).html(data);
						}
					});
			 		...
			 		$("#edit-vacancies").find("input, textarea").val("");
	...
	$(document).on('click', '#delete-vecacies', function() {
		var id = $(this).attr('data-id');

		var toServerValues = {};
		toServerValues['action'] = 'delete-vacancies';

		toServerValues['id'] = id;
